...
# Issues cause 'cylinders' and 'model year' are constant... so the intercept_
# takes their contribution...
...
# fine, is not crazy if the true one was 22...
...
# Rem: it was useful to remove the intercept to deal with the redundancy of
...
# Remark note that the centering/normalizing step does not modify the leverage.
leverage = np.diag(proj_mat)
data['Leverage'] = leverage
print(data.sort(['Leverage'], ascending=False).head(3))

print(data.describe())
# the maximum leverage has extreme 'displacement' and 'horsepower'
# the second maximum leverage has extreme 'weight' and 'horsepower'
# the third maximum leverage has extreme 'weight' and 'horsepower'
